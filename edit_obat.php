    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md">
          ...
          <?php
              include 'koneksi.php';
              $sql = "SELECT * FROM tbl_obat WHERE id_obat = '$_GET[edit]'";
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                  <label class="control-label" for="readOnlyInput">ID Obat</label>
                  <input class="form-control" id="readOnlyInput" readonly="" type="text" name="id_obat" value ="<?php echo $row['id_obat'];?>">
                </div>
                <div class="form-group">
                  <label class="control-label">Nama Obat</label>
                  <input class="form-control" type="text" name="nama_obat" value ="<?php echo $row['nama_obat'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="harga_obat" placeholder="Masukkan harga obat" value ="<?php echo number_format($row['harga_obat'], 0, ',', ''); ?>">
                </div>
            </div>
