...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-stethoscope"></i>  Data Pasien </h1>
          <p>Daftar isi data Pasien</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="coba.php"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Data Form</li>
          <li class="breadcrumb-item"><a href="datapasien.php">Data Pasien</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile-header pull-right btn-group">
                ...
                <a class="btn btn-primary" href="report_datapasien.php"><i class="fa fa-print" aria-hidden="true"></i></a>
			</div>
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered table-striped" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                        include 'koneksi.php';
                        $no = 1;
                        $sql_dokter = mysqli_query($koneksi, "SELECT * FROM tbl_datadiri") or die(mysqli_error($koneksi));
                        while($row = mysqli_fetch_array($sql_dokter)){
                            ...
                            "<tr>
                                ...
                                <div class=btn-group>
                                    ...
                                    <a class = 'btn btn-primary' href='?hapus=$row[id_pasien]' onclick = 'return checkdelete()'><i class='fa fa-lg fa-trash'></i></a>
                                </td>
                                </tr>";
                                $no++;
                            }
                ...
                <?php
                    if (isset($_GET['hapus'])) {
                        mysqli_query($koneksi,"DELETE FROM tbl_datadiri WHERE id_pasien = '$_GET[hapus]'");
                        echo "<script> alert('Data Telah Terhapus!'); document.location = 'datapasien.php'</script>";
                    }
