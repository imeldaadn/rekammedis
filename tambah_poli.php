          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="id_poli" placeholder="Masukkan ID Poli">
                </div>
                <div class="form-group">
                  <label class="control-label">Name Poli</label>
                  <input class="form-control" type="text" name="nama_poli" placeholder="Masukkan nama poli">
                </div>
                <div class="form-group">
                  <label class="control-label">Jam Operasi</label>
                  <input class="form-control" type="text" name="waktu" placeholder="Masukkan jam operasi">
                </div>
                <div class="form-group ">
            ...
            <?php
              ...
              if(isset($_POST['tambah'])){
                  mysqli_query($koneksi,"insert into tbl_poli set
