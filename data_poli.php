...
<html lang="en">
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Data Form</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="data_poli.php"><i class="icon fa fa-hospital-o"></i> Data Poli</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="icon fa fa-hospital-o"></i>  Form Data Poli </h1>
          <p>Silahkan isi data poli dengan menekan button tambah</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
          <a href="cetak_poli.php" class="btn btn-primary btn-xs"><i class="fa fa-download fa-sm text-white-50"></i> Generate Report</a>
          <div class="tile-header pull-right btn-group">
				<a href="" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-primary" href="tambah_poli.php"><i class="fa fa-lg fa-plus"></i></a>
			</div>
            <div class="tile-body">
              <div class="table-responsive">
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_array($sql)){
                            ...
                            "<tr>
                                ...
                                <td align='center'>
                                <div class=btn-group>
                                    <a class = 'btn btn-primary' href='edit_poli.php? edit=$row[id_poli]'><i class='fa fa-lg fa-edit'></i></a>
                                    <a class = 'btn btn-primary' href='?hapus=$row[id_poli]' onclick = 'return checkdelete()'><i class='fa fa-lg fa-trash'></i></a>
                                </td>
                                </tr>";
                                $no++;
                            }
                ...
                <?php
                    if (isset($_GET['hapus'])) {
                        mysqli_query($koneksi,"DELETE FROM tbl_poli WHERE id_poli = '$_GET[hapus]'");
                        echo "<script> alert('Data Telah Terhapus!'); document.location = 'data_poli.php'</script>";
                    }
