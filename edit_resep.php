...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="icon fa fa-file-archive-o"></i>  Form Data Resep </h1>
          <p>Silahkan ubah data resep lalu tekan button update</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Data Form</li>
          <li class="breadcrumb-item"><a href="data_resep.php">Data Resep</a></li>
          <li class="breadcrumb-item"><a href="#">Ubah Resep</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md">
          ...
          <?php
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="id_resep" value ="<?php echo $row['id_resep'];?>" readonly="">
                </div>
                <div class="form-group">
                  <label class="control-label">Tanggal Resep</label>
                  <input class="form-control" id="demoDate" type="text" name="tgl_resep" value ="<?php echo $row['tgl_resep'];?>" readonly="">
                </div>
                <div class="form-group ">
                  <label class="control-label">Nama Pasien</label>
                  <select class="form-control" id="id_pasien" multiple="" name = "id_pasien" readonly="">
                ...
                <div class="form-group ">
                  ...
                  <input class="form-control" type="text" id="harga_obat" readonly="" name="harga_obat" value ="<?php echo $row['harga_resep'];?>">
                  <script>
                    function Harga() {
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="sub_total" id="sub_total" readonly="" value ="<?php echo $row['sub_total'];?>">
                  <script>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="jumlah" id="jumlah" value ="<?php echo $row['jumlah'];?>" oninput="HitungSubTotal()">
                </div>
            </div>
            ...
            <?php
              include 'koneksi.php';
              if(isset($_POST['ubah'])){
                  mysqli_query($koneksi,"update tbl_resepobat set
