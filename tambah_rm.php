    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Silahkan isi data rekam medis lalu tekan button submit</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Tambah Rekam Medis</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="id_rm" placeholder="Masukkan ID Rekam Medis">
                </div>
                <div class="form-group ">
                  <label class="control-label">Nama Pasien</label>
                  <select class="form-control" id="id_pasien" multiple="id_rm[]" name = "id_pasien">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="diagnosa" placeholder="Masukkan diagnosa">
                </div>
            </div>
            ...
            <?php
              ...
              if(isset($_POST['tambah'])){
                  mysqli_query($koneksi,"insert into rekam_medis set
                  id_rm ='$_POST[id_rm]',
