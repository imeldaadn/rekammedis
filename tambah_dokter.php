    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Silahkan isi data dokter lalu tekan button submit</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Data Form</li>
          <li class="breadcrumb-item"><a href="data_dokter.php">Data Dokter</a></li>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="id_dokter" placeholder="Masukkan ID Dokter">
                </div>
                <div class="form-group">
                  <label class="control-label">Name</label>
                  <input class="form-control" type="text" name="nama_dokter" placeholder="Masukkan nama lengkap">
                </div>
                <div class="form-group">
                  <label class="control-label">Spesialis</label>
                  <input class="form-control" type="text" name="spesialis" placeholder="Masukkan jenis spesialis">
                </div>
                <div class="form-group">
                  <label class="control-label">Tanggal Lahir</label>
                  <input class="form-control" id="demoDate" type="text" name="tgl_lahir" placeholder="Masukkan tanggal lahir">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" type="text" rows="4" name="alamat" placeholder="Masukkan alamat"></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">No Telp.</label>
                  <input class="form-control" type="text" name="no_telp" placeholder="Masukkan no telpon">
                </div>
            ...
            <?php
              ...
              if(isset($_POST['tambah'])){
                  mysqli_query($koneksi,"insert into tbl_dokter set
