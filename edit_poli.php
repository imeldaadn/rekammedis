...
<html lang="en">
  <head>
    ...
    <title>REKAM MEDIS MEDICARE - FORM POLI</title>
    <!-- Bootstrap CSS -->
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-stethoscope"></i>  Form Data Poli </h1>
          <p>Silahkan ubah data dokter lalu tekan button update</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Data Form</li>
          <li class="breadcrumb-item"><a href="data_poli.php">Data Poli</a></li>
          <li class="breadcrumb-item"><a href="#">Ubah Poli</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md">
          ...
          <?php
              include 'koneksi.php';
              $sql = "SELECT * FROM tbl_poli, tbl_dokter 
              WHERE tbl_poli.id_dokter = tbl_dokter.id_dokter and id_poli = '$_GET[edit]'";
            ...
            <div class="tile-body">
              ...
              <div class="form-group">
                  <label class="control-label" for="readOnlyInput">ID Poli</label>
                  <input class="form-control" id="readOnlyInput" readonly="" type="text" name="id_poli" value ="<?php echo $row['id_poli'];?>">
                </div>
                <div class="form-group">
                  <label class="control-label">Nama Poli</label>
                  <input class="form-control" type="text" name="nama_poli" value ="<?php echo $row['nama_poli'];?>">
                </div>
                <div class="form-group">
                  <label class="control-label">Jam Operasi</label>
                  <input class="form-control" type="text" name="waktu" value ="<?php echo $row['waktu'];?>">
                </div>
                <div class="form-group ">
                  <label class="control-label">Nama Dokter</label>
                  <select class="form-control" id="demoSelect" multiple="" name = "id_dokter">
            ...
            <div class="tile-footer">
              ...
              <a class="btn btn-secondary" href="data_poli.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
            <?php
              if(isset($_POST['ubah'])){
                  mysqli_query($koneksi,"update tbl_poli set
                  nama_poli ='$_POST[nama_poli]',
                  waktu ='$_POST[waktu]',
                  id_dokter ='$_POST[id_dokter]'
                  where id_poli = '$_GET[edit]'
                  ") or die (mysqli_error($koneksi));

                  echo "
                  alert('Data Telah Tersimpan!');
                  <script> document.location = 'data_poli.php'</script>";
              }
            ?> 
            </form>
