    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Silahkan isi data dokter dengan menekan button tambah</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
          <a href="cetak_dokter.php" class="btn btn-primary btn-xs"><i class="fa fa-download fa-sm text-white-50"></i> Generate Report</a>
          <div class="tile-header pull-right btn-group">
				        <a href="" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-primary" href="tambah_dokter.php"><i class="fa fa-lg fa-plus"></i></a>
			    </div>
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered table-striped" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                        include 'koneksi.php';
                        $no = 1;
                        $sql_dokter = mysqli_query($koneksi, "SELECT * FROM tbl_dokter") or die(mysqli_error($koneksi));
                        while($row = mysqli_fetch_array($sql_dokter)){
                            echo
                            "<tr>
                                <td>$no</td>
                                <td>$row[id_dokter]</td>
                                ...
                                <td align='center'>
                                <div class=btn-group>
                                    <a class = 'btn btn-primary' href='edit_dokter.php? edit=$row[id_dokter]'><i class='fa fa-lg fa-edit'></i></a>
                                    <a class = 'btn btn-primary' href='?hapus=$row[id_dokter]' onclick = 'return checkdelete()'><i class='fa fa-lg fa-trash'></i></a>
                                </td>
                                </tr>";
                                $no++;
                            }
                ...
                <?php
                    if (isset($_GET['hapus'])) {
                        mysqli_query($koneksi,"DELETE FROM tbl_dokter WHERE id_dokter = '$_GET[hapus]'");
                        echo "<script> alert('Data Telah Terhapus!'); document.location = 'data_dokter.php'</script>";
                    }
