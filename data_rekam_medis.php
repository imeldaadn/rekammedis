    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Silahkan isi data rekam medis dengan menekan button tambah</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
          <a href="cetak_rm.php" class="btn btn-primary btn-xs"><i class="fa fa-download fa-sm text-white-50"></i> Generate Report</a>
          <div class="tile-header pull-right btn-group">
				        <a href="" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-primary" href="tambah_rm.php"><i class="fa fa-lg fa-plus"></i></a>
			    </div>
            <div class="tile-body">
              <div class="table-responsive">
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_array($sql)){
                            ...
                            "<tr>
                                ...
                                <td align='center'>
                                <div class=btn-group>
                                    <a class = 'btn btn-primary' href='edit_rm.php? edit=$row[id_rm]'><i class='fa fa-lg fa-edit'></i></a>
                                    <a class = 'btn btn-primary' href='?hapus=$row[id_rm]' onclick = 'return checkdelete()'><i class='fa fa-lg fa-trash'></i></a>
                                </td>
                                </tr>";
                                $no++;
                            }
                ...
                <?php
                    if (isset($_GET['hapus'])) {
                        mysqli_query($koneksi,"DELETE FROM rekam_medis WHERE id_rm = '$_GET[hapus]'");
                        echo "<script> alert('Data Telah Terhapus!'); document.location = 'data_rekam_medis.php'</script>";
                    }
