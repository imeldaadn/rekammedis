...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="icon fa fa-file-archive-o"></i>  Form Data Resep Obat </h1>
          <p>Silahkan isi data resep obat dengan menekan button tambah</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Data Form</li>
          <li class="breadcrumb-item"><a href="#">Data Resep Obat</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
          <a href="cetak_resep.php" class="btn btn-primary btn-xs"><i class="fa fa-download fa-sm text-white-50"></i> Generate Report</a>
          <div class="tile-header pull-right btn-group">
				        <a href="" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-primary" href="tambah_resep.php"><i class="fa fa-lg fa-plus"></i></a>
			    </div>
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered table-striped" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                        include 'koneksi.php';
                        $no = 1;
                        $sql = mysqli_query($koneksi, "SELECT * FROM tbl_resepobat 
                        ...
                        while($row = mysqli_fetch_array($sql)){
                            ...
                            "<tr>
                                ...
                                <td align='center'>
                                <div class=btn-group>
                                    <a class = 'btn btn-primary' href='?hapus=$row[id_resep]' onclick = 'return checkdelete()'><i class='fa fa-lg fa-trash'></i></a>
                                </td>
                                </tr>";
                                $no++;
                            }
                ...
                <?php
                    if (isset($_GET['hapus'])) {
                        mysqli_query($koneksi,"DELETE FROM tbl_resepobat WHERE id_resep = '$_GET[hapus]'");
                        echo "<script> alert('Data Telah Terhapus!'); document.location = 'data_resep.php'</script>";
                    }
