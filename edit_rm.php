...
<html lang="en">
  <head>
    ...
    <title>REKAM MEDIS MEDICARE - FORM REKAM MEDIS</title>
    <!-- Bootstrap CSS -->
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Data Form</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="data_rekam_medis.php"><i class="icon fa fa-file-archive-o"></i> Data Rekam Medis</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="icon fa fa-file-archive-o"></i>  Form Data Rekam Medis </h1>
          <p>Silahkan ubah data rekam medis lalu tekan button update</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Data Form</li>
          <li class="breadcrumb-item"><a href="data_rekam_medis.php">Data Rekam Medis</a></li>
          <li class="breadcrumb-item"><a href="#">Ubah Rekam Medis</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md">
          ...
          <?php
              ...
              INNER JOIN tbl_datadiri ON rekam_medis.id_pasien = tbl_datadiri.id_pasien
              INNER JOIN tbl_poli ON rekam_medis.id_poli = tbl_poli.id_poli
              INNER JOIN tbl_dokter ON rekam_medis.id_dokter = tbl_dokter.id_dokter 
              and id_rm = '$_GET[edit]'";
              $result = mysqli_query($koneksi, $sql);
              $row = mysqli_fetch_array($result);
            ?>
            <h3 class="tile-title">Form Ubah</h3>
            <div class="tile-body">
              <form method="post" action="">
              <div class="form-group">
                  <label class="control-label">ID Rekam Medis</label>
                  <input class="form-control" type="text" name="id_rm" value ="<?php echo $row['id_rm'];?>">
                </div>
                <div class="form-group">
                  <label class="control-label">Diagnosa</label>
                  <input class="form-control" type="text" name="diagnosa" value ="<?php echo $row['diagnosa'];?>">
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                  ...
                  <select class="form-control" id="id_poli" multiple="" name = "id_poli">
                ...
                <div class="form-group ">
                  ...
                  <select class="form-control" id="id_dokter" multiple="" name = "id_dokter">
                    <optgroup label="Pilih Nama Dokter">
                        <?php
            ...
            <div class="tile-footer">
              ...
              <a class="btn btn-secondary" href="data_rekam_medis.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
            <?php
              include 'koneksi.php';
              if(isset($_POST['ubah'])){
                  mysqli_query($koneksi,"update rekam_medis set
                  id_pasien ='$_POST[id_pasien]',
                  id_poli ='$_POST[id_poli]',
                  id_dokter ='$_POST[id_dokter]',
                  diagnosa ='$_POST[diagnosa]'
                  where id_rm = '$_GET[edit]'
                  ") or die (mysqli_error($koneksi));

                  echo "
                  alert('Data Telah Tersimpan!');
                  <script> document.location = 'data_rekam_medis.php'</script>";
              }
            ?> 
            </form>
